...
const Chatbot = () => {
    ...
    useEffect(() => {
        setMessages([
            {
                role: 'assistant',
                content: 'Hello! I’m Cherry, here to assist you. What would you like to talk about? 😊',
    ...
    return (
        <Container className={`chat-container ${isDarkTheme ? 'dark-theme' : ''}`}>
            ...
            <h2 className="text-center mb-4 title">Cherry Chatbot</h2>

            <Card className="chat-card">
                <Card.Body>
                    <Card.Title>Chat with Cherry</Card.Title>
                    <Row className="mb-3">
                            ...
                            <ListGroup.Item key={index} className="border-0">
                                <Row className={msg.role === 'user' ? 'justify-content-end' : 'justify-content-start'}>
                                    <Col xs="auto">
                                        {msg.role === 'assistant' && (
                                            <img
                                                src="https://t3.ftcdn.net/jpg/08/13/02/18/360_F_813021887_Ii79nIg4a51bWBKQQrPSQFAzkwgz6e9w.jpg"
                                                alt="Bot Avatar"
                                                className="avatar"
                                            />
                                        )}
                                    ...
                                    <Col xs="auto" className="p-0">
                                        <div className={`message-bubble ${msg.role === 'user' ? 'user-message' : 'bot-message'}`}>
                                            <strong>{msg.role === 'user' ? 'You' : 'Cherry'}:</strong> {msg.content}
